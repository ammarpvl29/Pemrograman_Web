            ...
            <div class="pt-20 px-4">
                ...
                <div class="text-center mb-8">
                    <div class="flex justify-center items-center gap-4">
                        <a href="todo.html" class="btn btn-ghost">TODO LIST</a>
                        <a href="habits.html" class="btn btn-primary">HABITS</a>
                    </div>
                </div>
                ...
                <div class="max-w-3xl mx-auto bg-base-300 rounded-lg p-6">
                    ...
                    <div class="input-section flex gap-4 mb-6">
                        <input type="text" placeholder="Add a new habit . . ." class="input input-bordered input-secondary flex-grow" />
                        <select class="select select-secondary w-40" id="frequency">
                            <option value="daily">Daily</option>
                            <option value="weekly">Weekly</option>
                            <option value="monthly">Monthly</option>
                        </select>
                        <button class="btn btn-secondary add-habit-button">
                            <i class="bx bx-plus bx-sm"></i>
                        </button>
                    </div>

                    <div class="habits-filter flex justify-between mb-6">
                        <button class="btn">FILTER</button>
                        <button class="btn btn-secondary reset-all-btn">
                            RESET ALL STREAKS
                        </button>
                    </div>
        ...
        <div class="drawer-side">
            ...
            <div class="menu p-4 w-80 min-h-full bg-base-200 text-base-content">
                ...
                <ul>
                    ...
                    <li><a href="habits.html" class="active">Habits</a></li>
